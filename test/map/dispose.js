...
test("disposer index works correctly", () => {
  ...
  expect(el.innerHTML).toBe(lis("44,55,33"));
});
...
test("last algorithm insertNodes -> disposes correct index", () => {
  ...
  expect(el.innerHTML).toBe(lis("1,2,3,4,5"));

  list([one, four, five, three, two]);
  expect(el.innerHTML).toBe(lis("1,4,5,3,2"));

  list([one, two, three, four]);
  expect(el.innerHTML).toBe(lis("1,2,3,4"));
  ...
  expect(el.innerHTML).toBe(lis("11,22,33,44"));
});
...
test("swap backward -> disposes correct index", () => {
  ...
  expect(el.innerHTML).toBe(lis("1,2,5,3,4"));
...
test("swap forward -> disposes correct index", () => {
  ...
  expect(el.innerHTML).toBe(lis("2,3,1,4,5"));

  list([two, three, four, five]);
  expect(el.innerHTML).toBe(lis("2,3,4,5"));
...
test("removing one observable diposes correct index", () => {
  ...
  expect(el.innerHTML).toBe(lis("1,2,3,4,5,6,7"));

  list([1, two, four, 3, 5, six, 7]);
  expect(el.innerHTML).toBe(lis("1,2,4,3,5,6,7"));

  list([1, two, 3, six, 7]);
  four(44);
  two(22);
  expect(el.innerHTML).toBe(lis("1,22,3,6,7"));
...
test("explicit dispose works and disposes observables", () => {
  ...
  list([1, 2, four, 3]);
  expect(el.innerHTML).toBe(lis("1,2,4,3"));
