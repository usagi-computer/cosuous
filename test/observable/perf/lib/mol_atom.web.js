  ...
  var $mol_object = (function () {
    ...
    $mol_object.objectPath = function () {
      ...
      return (
        self["name"] ||
        self["displayName"] ||
        (self["displayName"] = Function.prototype.toString
          .call(self)
  ...
  var $mol_set_shim = (function () {
    ...
    $mol_set_shim.prototype.forEach = function (handle) {
      for (var key in this._index) {
        ...
        this._index[key].forEach(function (val, index) {
...
(function ($) {
  ...
  var $mol_atom = (function (_super) {
    ...
    $mol_atom.prototype.actualize = function () {
      ...
      if (this.status === $mol_atom_status.checking) {
        this.masters.forEach(function (master) {
          if (_this.status !== $mol_atom_status.checking) return;
          master.actualize();
        });
        if (this.status === $mol_atom_status.checking) {
    ...
    $mol_atom.prototype.obey = function (master) {
      if (!this.masters) this.masters = new $.$mol_set();
