      ...
      1: [
        function (require, module, exports) {
          (function (global) {
            ...
            var computedDecorator = createClassPropertyDecorator(
              function (target, name, _, decoratorArgs, originalDescriptor) {
                invariant(
                ...
                if (
                  ...
                  decoratorArgs[0].asStructure === true
                )
                ...
                defineObservableProperty(
                  adm,
                  name,
                  compareStructural ? asStructure(baseValue) : baseValue,
                  false,
                  setter,
                );
              },
            ...
            function computed(targetOrExpr, keyOrScopeOrSetter, baseDescriptor, options) {
              if (typeof targetOrExpr === "function" && arguments.length < 3) {
                ...
                else return computedExpr(targetOrExpr, undefined, keyOrScopeOrSetter);
              }
            ...
            function interceptInterceptable(thing, handler) {
              if (isPlainObject(thing) && !isObservableObject(thing)) {
                deprecated(
                  "Passing plain objects to intercept / observe is deprecated and will be removed in 3.0",
                );
            ...
            function isObservable(value, property) {
              ...
              return (
                !!value.$mobx ||
                value instanceof BaseAtom ||
                value instanceof Reaction ||
                value instanceof ComputedValue
              );
            }
            exports.isObservable = isObservable;
            var decoratorImpl = createClassPropertyDecorator(
              function (target, name, baseValue) {
            ...
            function observable(v, keyOrScope) {
              ...
              var _a = getValueModeFromValue(v, ValueMode.Recursive),
                ...
                value = _a[1];
              var sourceType =
                mode === ValueMode.Reference ? ValueType.Reference : getTypeOfValue(value);
              switch (sourceType) {
            ...
            function whyRun(thing, prop) {
              switch (arguments.length) {
                case 0:
                  ...
                  if (!thing)
                    return log(
                      "whyRun() can only be used if a derivation is active, or by passing an computed value / reaction explicitly. If you invoked whyRun from inside a computation; the computation is currently suspended but re-evaluating because somebody requested it's value.",
                    );
                  break;
                case 2:
              ...
              thing = getAtom(thing);
              if (thing instanceof ComputedValue) return log(thing.whyRun());
              else if (thing instanceof Reaction) return log(thing.whyRun());
              else invariant(false, "whyRun can only be used on reactions and computed values");
            }
            ...
            function executeAction(actionName, fn, scope, args) {
              invariant(
                !(globalState.trackingDerivation instanceof ComputedValue),
                "Computed values or transformers should not invoke actions or trigger other side effects",
              );
            ...
            function useStrict(strict) {
              if (arguments.length === 0) {
                deprecated(
                  "`useStrict` without arguments is deprecated, use `isStrictModeEnabled()` instead",
                );
            ...
            var ComputedValue = (function () {
              ...
              ComputedValue.prototype.set = function (value) {
                if (this.setter) this.setter.call(this.scope, value);
                else
                  throw new Error(
                    "[ComputedValue '" +
                      this.name +
            ...
            function handleExceptionInDerivation(derivation) {
              var message =
                ...
                ("Please fix the error reported after this message or enable 'Pause on (caught) exceptions' in your debugger to find the root cause. In: '" +
                  derivation.name +
                  "'. ") +
            ...
            function trackTransitions(onReport) {
              ...
              if (typeof onReport === "boolean") {
                deprecated(
                  "trackTransitions only takes a single callback function. If you are using the mobx-react-devtools, please update them first",
                );
                onReport = arguments[1];
              }
              if (!onReport) {
                deprecated(
                  "trackTransitions without callback has been deprecated and is a no-op now. If you are using the mobx-react-devtools, please update them first",
                );
                return function () {};
              }
              return spy(onReport);
            ...
            function assertUnwrapped(value, message) {
              if (
                ...
                throw new Error(
                  "[mobx] asStructure / asReference / asFlat cannot be used here. " + message,
                );
            }
            ...
            var ObservableArrayAdministration = (function () {
              ...
              ObservableArrayAdministration.prototype.spliceWithArray = function (
                ...
                var res = (_a = this.values).splice.apply(
                  _a,
            ...
            var ObservableArray = (function (_super) {
              ...
              ObservableArray.prototype.toString = function () {
                return (
                  "[mobx.array] " + Array.prototype.toString.apply(this.$mobx.values, arguments)
                );
              };
              ObservableArray.prototype.toLocaleString = function () {
                return (
                  "[mobx.array] " +
                  Array.prototype.toLocaleString.apply(this.$mobx.values, arguments)
                );
              };
            ...
            var ObservableMap = (function () {
              function ObservableMap(initialData, valueModeFunc) {
                ...
                allowStateChanges(true, function () {
                  if (isPlainObject(initialData)) _this.merge(initialData);
            ...
            function setObservableObjectInstanceProperty(adm, propName, value) {
              ...
              else defineObservableProperty(adm, propName, value, true, undefined);
            }
            function defineObservableProperty(adm, propName, newValue, asInstanceProperty, setter) {
              ...
              if (newValue instanceof ObservableValue) {
                ...
                newValue instanceof AsStructure &&
                typeof newValue.value === "function" &&
            ...
            function getAtom(thing, property) {
              if (typeof thing === "object" && thing !== null) {
                ...
                if (
                  thing instanceof BaseAtom ||
                  thing instanceof ComputedValue ||
                  thing instanceof Reaction
                ) {
                  return thing;
                }
            ...
            var SimpleEventEmitter = (function () {
              function SimpleEventEmitter() {
                this.listeners = [];
                deprecated(
                  "extras.SimpleEventEmitter is deprecated and will be removed in the next major release",
                );
              }
            ...
            function deepEquals(a, b) {
              ...
              if (aIsArray !== (Array.isArray(b) || isObservableArray(b))) {
                ...
                for (var i = a.length - 1; i >= 0; i--) if (!deepEquals(a[i], b[i])) return false;
                return true;
