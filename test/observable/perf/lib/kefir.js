...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === "object") exports["Kefir"] = factory();
  else root["Kefir"] = factory();
})(this, function () {
    ...
    /******/ [
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        extend(Observable.prototype, {
          ...
          log: function log() {
            var name =
              arguments.length <= 0 || arguments[0] === undefined ? this.toString() : arguments[0];
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        module.exports = function (obs) {
          var Promise =
            arguments.length <= 1 || arguments[1] === undefined ? getGlodalPromise() : arguments[1];
        ...
        inherit(FlatMap, AbstractPool, {
          ...
          _handleMain: function _handleMain(event) {
            if (event.type === VALUE) {
              ...
              var sameCurr =
                this._activating && this._hadNoEvSinceDeact && this._lastCurrent === event.value;
              if (!sameCurr) {
