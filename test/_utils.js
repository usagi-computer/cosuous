export function normalizeSvg(html) {
  ...
  const htmlStr = typeof html === "string" ? html : new XMLSerializer().serializeToString(html);

  // Normalization logic from Preact test helpers.
  return normalizeAttributes(htmlStr.replace(' xmlns="http://www.w3.org/2000/svg"', ""));
}
